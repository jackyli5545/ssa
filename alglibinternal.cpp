...
ae_bool rmatrixsyrkf(ae_int_t n,
     ...
     ae_state *_state)
{
    // Serial.println("ALGLIB_INTERCEPTS_ABLAS");
    // Serial.println(ALGLIB_INTERCEPTS_ABLAS);
#ifndef ALGLIB_INTERCEPTS_ABLAS
    ae_bool result;
    ...
    return result;
#else
        ae_bool (*funpointer)(ae_int_t, ae_int_t, double, ae_matrix *, ae_int_t, ae_int_t, ae_int_t, double, ae_matrix *, ae_int_t, ae_int_t, ae_bool);
    char buffer[100];
    // funpointer = _ialglib_i_rmatrixsyrkf;
    //   sprintf(buffer, "_ialglib_i_rmatrixsyrkf %p", &funpointer);
